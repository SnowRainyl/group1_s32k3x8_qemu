...
#if !defined(S32K358_COMMON_H_)  /* Check if memory map has not been already included */
#define S32K358_COMMON_H_
#define MCU_S32K358

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32K358 memory map: There is already included another memory map. Only one memory map can be included.
...
#define NUMBER_OF_INT_VECTORS 249                /**< Number of interrupts in the Vector table */
...
typedef enum {
  ...
  FlexCAN6_0_IRQn              = 125,              /**< Interrupt indicating that the CAN bus went to Bus Off state */
  FlexCAN6_1_IRQn              = 126,              /**< Message Buffer Interrupt line 0-31 */
  FlexCAN7_0_IRQn              = 127,              /**< Interrupt indicating that the CAN bus went to Bus Off state */
  FlexCAN7_1_IRQn              = 128,              /**< Message Buffer Interrupt line 0-31 */
  ...
  FlexCAN6_2_IRQn              = 134,              /**< Message Buffer Interrupt line 32-63 */
  FlexCAN7_2_IRQn              = 135,              /**< Message Buffer Interrupt line 32-63 */
  ...
  USDHC_IRQn                   = 177,              /**< uSDHC Interrupt */
  ...
  SoC2_IRQn                    = 214,              /**< PLL2 LOL interrupt */
  XRDC_IRQn                    = 216,              /**< XRDC Error Interrupt */
  GMAC_COMM_IRQn               = 224,              /**< Common interrupt */
  GMAC_CH_0_TX_IRQn            = 225,              /**< Channel0 TX interrupt */
  GMAC_CH_0_RX_IRQn            = 226,              /**< Channel0 RX interrupt */
  GMAC_CH_1_TX_IRQn            = 227,              /**< Channel1 TX interrupt */
  GMAC_CH_1_RX_IRQn            = 228,              /**< Channel1 RX interrupt */
  GMAC_CH_2_TX_IRQn            = 229,              /**< Channel2 TX interrupt */
  GMAC_CH_2_RX_IRQn            = 230,              /**< Channel2 RX interrupt */
  GMAC_SIC_IRQn                = 231,              /**< Safety interrupt correctable */
  GMAC_SIUC_IRQn               = 232               /**< Safety interrupt un-correctable */
} IRQn_Type;
...
#endif  /* #if !defined(S32K358_COMMON_H_) */
